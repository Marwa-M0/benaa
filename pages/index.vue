<template>
  <div class="h-screen flex flex-col md:flex-row relative">
    <!-- Background Section -->
    <div
      class="absolute md:relative inset-0 h-full w-full md:w-1/2 bg-[url('/bg.png')] bg-cover bg-center"
    >
      <div class="hidden md:flex justify-center items-center h-full">
        <img
          src="/heart-hands.png"
          alt="Heart Hands"
          class="w-3/4 max-w-xs md:max-w-sm"
        />
      </div>
    </div>
    ...
    <!-- Form Section -->
    <div
      class="absolute inset-0 md:relative md:w-1/2 flex justify-center items-center p-4"
    >
      <div
      ...
      >
        ...
        >
          ...
          <div
            class="lg:w-40 lg:h-40 md:w-32 md:h-32 w-24 h-24 flex items-center justify-center rounded-full bg-gradient-to-b from-[#169FAE] to-[#138B96] p-2 mb-4"
          >
            <img
              src="/logo.png"
              alt="Logo"
