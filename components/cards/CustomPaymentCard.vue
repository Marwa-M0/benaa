    ...
    <div class="w-full lg:w-4/5 p-6 border border-gray-300 rounded-lg shadow-sm bg-white">
      ...
      <form @submit.prevent="handlePayment" id="moyasar-token-form">
        ...
        <div class="mt-4">
          ...
          <UInput v-model="form.cardholderName" class="w-full border-gray-300 p-2 rounded-lg" color="white"
            variant="outline" placeholder="اسم حامل البطاقة" />
        ...
        <div class="mt-4">
          ...
          <UInput v-model="form.cardNumber" class="w-full border-gray-300 p-2 rounded-lg" color="white"
            variant="outline" placeholder="رقم البطاقة" @input="formatCardNumber"
        ...
        <div class="mt-4 flex gap-4">
          <div class="flex-1">
            ...
            <UInput v-model="form.expiryDate" placeholder="شهر/سنة" class="w-full border-gray-300 p-2 rounded-lg"
              color="white" variant="outline" @input="handleExpiryDateInput" maxlength="5" />
          ...
          <div class="flex-1">
            ...
            <UInput v-model="form.cvv" placeholder="CVV" class="w-full border-gray-300 p-2 rounded-lg" color="white"
              variant="outline" maxlength="4" />
        ...
        <div class="mt-6 text-center">
          <UButton type="submit" class="w-full bg-[#138B96] text-white font-bold py-2 rounded-lg text-center"
            color="primary" variant="solid" block :disabled="isSubmitting">
            تبرع الآن
          </UButton>
        </div>
      </form>
